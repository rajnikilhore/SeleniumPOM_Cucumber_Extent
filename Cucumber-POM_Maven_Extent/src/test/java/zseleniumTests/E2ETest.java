	...
	public class E2ETest {
	 ...
	 public static void main(String[] args) throws InterruptedException {
		 System.setProperty("webdriver.chrome.driver",
					"C:\\Users\\RajniKilhore\\eclipse-workspace\\SE-CSE-IBM\\drivers\\chromedriver.exe");
	 ...
	 List<WebElement> coloritems = color.getOptions();
	 coloritems.get(1).click();;
	
	 Select size =new Select(driver.findElement(By.cssSelector("#pa_size")));
	 List<WebElement> sizeitems = size.getOptions();
	 sizeitems.get(1).click();
	 ...
	 List<WebElement> stateitems = state.getOptions();
